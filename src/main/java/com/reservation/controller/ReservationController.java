...
public class ReservationController {
    ...
    public ResponseEntity<List<BookingDto>> getAllReservations() {
        ...
        for (Seat seat : seats) {
            ...
            Route route = routeRepository.findById(passengerOptional.get().getRouteId()).get();
            ...
            if (passengerOptional.isPresent()) {
                ...
                bookingDto.setFromLocation(route.getFromLocation());
                bookingDto.setToLocation(route.getToLocation());
                bookingDto.setFromDate(route.getFromDate());
                bookingDto.setToDate(route.getToDate());
                bookingDto.setFromTime(route.getFromTime());
                bookingDto.setTotalTime(route.getTotalTime());
    ...
    public ResponseEntity<?> getReservationByBusId(@RequestParam("busId") Long busId) {
        ...
        for (Seat seat : listOfSeatsOnBusId) {
            ...
            Route route = routeRepository.findById(passenger.getRouteId()).get();
